...
variable "project_name" {
  ...
  type        = string
  default     = "student-training"
}

variable "student_id" {
  description = "Student identifier for unique resource naming"
  type        = string
}
```
...
student_id = "student1"  # Change for each student: student1, student2, etc.

# Token is set via environment variable HCLOUD_TOKEN
# Alternatively, you can set it here (but be careful with secrets!)
